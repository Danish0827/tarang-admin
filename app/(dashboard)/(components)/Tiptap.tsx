...
if (!editor) return null;
  return (
    <div className="bg-background relative rounded-lg border shadow-sm text-editor-styles dark:border-slate-500">
      {editor && (
        <>
      ...
      <EditorContent editor={editor} className="min-h-[300px] px-4 py-3 !bg-white dark:!bg-[#273141] rounded-b-lg" />
    </div>
  );
};
    ...
    <Popover open={isLinkPopoverOpen} onOpenChange={setIsLinkPopoverOpen}>
      ...
      <PopoverContent className="w-80 p-4">
        <div className="flex flex-col gap-4">
          <h3 className="font-medium text-2xl">Insert Link</h3>
          <Input
